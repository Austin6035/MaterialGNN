...
parser.add_argument('data_src', metavar='PATH', help='data source: dataset/data_src')
...
parser.add_argument('--h-fea-len', default=16, type=int, metavar='N',
                    help='number of hidden features after pooling')
parser.add_argument('--nbr-fea-len', default=16, type=int, metavar='N',
...
parser.add_argument('--l2', default=0, type=int, metavar='N',
...
attention_group.add_argument('--cgcnn', '-gcn1', action='store_true',
...
def main():
    ...
    logger.info('dataset path = {}'.format(args.data_src))
    ...
    dataset = GraphData(cif_dir=args.data_src, max_num_nbr=args.max_num_nbr, radius=args.radius,
